...
class CustomTabBar: UIView {
    ...
    convenience init(menuItems: [TabItem], frame: CGRect) {
        ...
        layer.backgroundColor = UIColor(named: StyleHelper.backgroundColor.rawValue)?.cgColor
    ...
    func createTabItem(item: TabItem) -> UIView {
        ...
        tabBarItem.layer.backgroundColor = UIColor(named: StyleHelper.backgroundColor.rawValue)?.cgColor
        ...
        itemTitleLabel.textColor = UIColor(named: StyleHelper.textColor.rawValue)
